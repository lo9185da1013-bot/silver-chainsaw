...
public class GuiMainMenu extends GuiScreen {
	...
	/** Previous right-shift state to detect press events */
	private boolean prevRShiftDown = false;
	...
	private net.minecraft.client.renderer.texture.DynamicTexture customBgTexture = null;
	private ResourceLocation customBgResourceLocation = null;
	...
	public void updateScreen() {
		// detect right-shift press (keyboard modifiers aren't delivered to keyTyped)
		boolean rshift = Keyboard.isKeyDown(54);
		if (rshift && !this.prevRShiftDown) {
			this.mc.displayGuiScreen(new net.peyton.eagler.mod.GuiModMenu(this));
		}
		this.prevRShiftDown = rshift;
	}
	...
	protected void keyTyped(char typedChar, int keyCode) throws IOException {
		// Right shift opens the mod menu
		if (keyCode == 54) {
			this.mc.displayGuiScreen(new net.peyton.eagler.mod.GuiModMenu(this));
		}
	}
	...
	public void initGui() {
		...
		// Mods button at the bottom of the main menu for quick access
		this.buttonList.add(new GuiButton(99, this.width / 2 - 100, this.height - 48, 200, 20, "Mods"));
	}
	...
	private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
		...
		this.buttonList.add(new GuiButton(99, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, "Mods (Right Shift)"));
		this.buttonList
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		try {
			...
			net.lax1dude.eaglercraft.opengl.WorldRenderer wr = Tessellator.getInstance().getBuffer();
			...
			// Fallback: premium space-themed gradient background
			this.drawGradientRect(0, 0, this.width, this.height, 0xFF0a0e27, 0xFF1a1a3e);
			// Nebula overlay effects
			GlStateManager.enableBlend();
			GlStateManager.blendFunc(770, 771);
			this.drawRect(0, 0, this.width / 4, this.height, 0x1a4400ff);
			this.drawRect(this.width * 3 / 4, 0, this.width, this.height, 0x1a0044ff);
			this.drawRect(0, this.height / 2, this.width / 3, this.height, 0x15ff00ff);
			GlStateManager.disableBlend();
		}

		// Massive AstroClient title with glow effect
		GlStateManager.pushMatrix();
		...
		// Draw glow (shadow)
		this.drawCenteredString(this.fontRendererObj, "ASTROCLIENT", 0, -1, 0x0088FFFF);
		this.drawCenteredString(this.fontRendererObj, "ASTROCLIENT", 0, 0, 0xFF00FFFF);
		GlStateManager.popMatrix();
		...
		this.drawString(this.fontRendererObj, "AstroClient 1.12.2 (" + EaglercraftVersion.projectOriginVersion + ")", 2,
				this.height - 10, -1);
