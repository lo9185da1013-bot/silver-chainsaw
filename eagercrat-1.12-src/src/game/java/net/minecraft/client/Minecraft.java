...
import net.peyton.eagler.mod.AstroClientModSystem;
...
public class Minecraft implements IThreadListener {
	...
	private void startGame() throws IOException {
		...
		// Initialize AstroClient mod system
		AstroClientModSystem.initialize(this);
	...
	public void runTick() throws IOException {
		...
		// Hook mod system onTick
		AstroClientModSystem.onClientTick();
	...
	private void runTickKeyboard() throws IOException {
		while (Keyboard.next()) {
			...
			// Hook mod system onKeyPress (always check for F7 mod menu, mods handle when to act based on screen state)
			if (Keyboard.getEventKeyState()) {
				AstroClientModSystem.onKeyPress(i);
			}
